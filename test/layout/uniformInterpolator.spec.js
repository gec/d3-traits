describe('d3-traits.layout.uniformInterpolator', function() {
  ...
  it('should map points to uniform X values with empty series', function() {
    var series, result
  ...
  it('should map points to uniform X values', function() {
    ...
    expect( result[0][0]).toEqual( {x: 4.999, y: 5})
    expect( result[1][0]).toEqual( {x: 4.999, y: 2})
    expect( result[2][0]).toEqual( {x: 5, y: 6})

    expect( result[0][1]).toEqual( {x: 7, y: 5})
    expect( result[1][1]).toEqual( {x: 7, y: 8})
    expect( result[2][1]).toEqual( {x: 7, y: 6})
  });
